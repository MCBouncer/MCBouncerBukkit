...
public class BukkitGlobalNoteCommand extends GlobalNoteCommand implements CommandExecutor {
    public BukkitGlobalNoteCommand(MCBouncerImplementation plugin) {
        super(plugin);
    }
